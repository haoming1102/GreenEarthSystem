	...
	<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
			...
			<div class="collapse navbar-collapse" id="navbarsExampleDefault">
				<ul class="navbar-nav mr-auto">
					<li class="nav-item">
						<a class="nav-link" href="registerC.php"> Collector Registration</a>
					</li>
				</ul>
	...
	<div class="container">
			...
			<div class="col">
				...
				<form action="signupR.php" method="post">
					<div style="font-size:25px; margin:0 25% 0 ;text-align:center;"><b>Recycler Registration</b></div>
					<br>
					<div class="form-row">
					...
					<!-- <div class="form-row">
						...
						<div class="form-group col-md-12">
							...
							<label for="IC_checking"><b>IC/Passport</b> </label>
							<input type="text" name="ic" placeholder="90xxx-xx-xxxx" onfocusout="validate_ic()" class="form-control" id="ic_checking"/>
						</div>
					...
					<br>
					<div style="margin:0 25% 0 ;text-align:center;"><button type="submit" name="signUpR" class="btn btn-lg btn-outline-success" onclick="register()" id="regis">Register</button></div>
