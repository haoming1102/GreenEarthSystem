...
<body>
  ...
  <!--navigation-->
	<nav class="navbar navbar-expand-md navbar-dark bg-dark sticky-top">
        ...
        <li class="nav-item pill-2">
            <a class="nav-link active" href="#" style ="color:white">Your Profile</a>
        </li>
  ...
  <div align="center" id="font"> Collector info </div>
      ...
      <?php while($row = mysqli_fetch_array($result)):?>
  		...
  		<div class="col-md-3">
  			<div class="contact-info">
  				<div id="pic"><img src="icon_c.png" alt="image" height="200px" width="200px"/></div>
          ...
          <div class="form-group">
  				  ...
  				  <div class="col-sm-10">
  					<input type="text" class="form-control" id="address" value="<?php echo $row['address'];?>" name="address" style="background-color:white" readonly>
  				  </div>
  				</div>
          <br>
            ...
            <button type="button"  class="btn btn-default" id="fn" id = "fn" data-toggle="modal" data-target="#pop<?php echo $row['id'];?>">Change Fullname</button>

  				</div>

          <!-- change password modal open -->
          <form  action="changepw_c.php" method="POST">
            ...
            <div class="modal-dialog modal-dialog-centered">
              ...
              <div class="modal-body">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-md-6">
                    <input type="password"  name="c_oldpw" >
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="form-group col-md-6">
                    <input type="password"  name="c_newpw" >
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="form-group col-md-6">
                    <input type="password"  name="c_conpw" >
                  </div>
                </div>
          ...
          <form  action="changefn_c.php" method="POST">
            ...
            <div class="modal-dialog modal-dialog-centered">
              ...
              <div class="modal-body">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-md-6">
                    <input type="text"  name="C_ID" value="<?php echo $row['fullname'];?>" style="background-color:#f2f2f2" readonly>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="form-group col-md-6">
                    <input type="text"  name="c_fullname" >
                  </div>
                </div>
